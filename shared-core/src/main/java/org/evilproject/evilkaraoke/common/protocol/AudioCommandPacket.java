...
public record AudioCommandPacket(
        ...
        String reason,
        Duration fadeOut,
        AudioDeliveryMode deliveryMode
    ...
    public AudioCommandPacket(
        ...
        this(command, sessionId, playbackId, track, target, offset, serverTime, reason, fadeOut, AudioDeliveryMode.URL);
    }
    ...
    public AudioCommandPacket {
        ...
        deliveryMode = deliveryMode == null ? AudioDeliveryMode.URL : deliveryMode;
    }
}
